...
public class HomePage {
	...
	private <btnClockout> void initialize() {
		...
		if(personnel.getPermission()==1){
			//ArrayList<TimeReported>timeReported = TimeSystem.getUserTimeReported(personnel.getID);
			//for(TimeReported report : timeReported){
			//	dtm.addRow(new Object[] { report.getID(), report.getName(), report.getDate()
			//	, report.getIntime(), report.getOuttime(), report.getSalaryPerHour()});
			//}
		}
		else if(personnel.getPermission()==2){
			//ArrayList<TimeReported>timeReported = TimeSystem.getAllTimeReported();
			//for(TimeReported report : timeReported){
			//	dtm.addRow(new Object[] { report.getID(), report.getName(), report.getDate()
			//	, report.getIntime(), report.getOuttime(), report.getSalaryPerHour()});
			//}
		}
		dtm.addRow(new Object[] { "dummyData1", "data", "data","data", "data", "data" });
		dtm.addRow(new Object[] { "dummyData2", "data", "data","data", "data", "data" });
		...
		if(personnel.getPermission()==2){
			...
			//}
			manageModel.addRow(new Object[] { "dummyData1", "data", "data","data", "data", "data" });
			manageModel.addRow(new Object[] { "dummyData2", "data", "data","data", "data", "data" });
